...
$data = file_get_contents('components/com_vmmanager/helpers/config/logIn.json');
...
<div id="popupHeader">
    <ul>
        ...
        <li data="#styleItem" class=""><?php echo JText::_('OPC_POPUP_TABS_STYLE') ?></li>
    </ul>
</div>
<div id="popupItem">
    <div id="styleItem" class="">
    ...
    <div id="privateItem" class="active">
        <div class="description-example-color">
            <p><?php echo JText::_('OPC_POPUP_LOGIN_DESC') ?></p>
        </div>
        <form name="optionForm" action="#" method="POST" id="optionForm">
            <div class="baner-row">
                <div class="title-and-desc">
                    <h3 class="title"><?php echo JText::_('OPC_POPUP_LOGIN_POPUP') ?></h3>
                    <p class="desc"><?php echo JText::_('OPC_POPUP_LOGIN_POPUP_DESC') ?></p>
                </div>
                <div class="row-val">
                    <span class="onoffswitch">
                    <input <?php if($dataOption->popupType):?> checked="" <?php endif; ?> type="checkbox" value="1" name="popupType" class="onoffswitch-checkbox" id="popupType"/>
                        <label class="onoffswitch-label" for="popupType">
