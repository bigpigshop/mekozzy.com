...
$data = file_get_contents('components/com_vmmanager/helpers/config/banner.json');
$data = json_decode($data);
$dataStyle = $data->color;
$dataOption = $data->options;
if(empty($dataStyle->contentTxtFont)) $dataStyle->contentTxtFont = 0;
?>
...
<div id="popupItem">
    ...
    <div id="privateItem" class="active">
        <div class="description-example-color">
            <p><?php echo JText::_('OPC_POPUP_BANNER_DESC') ?></p>
        </div>
        <form name="optionForm" action="#" method="POST" id="optionForm">
            <!---->
            <div class="baner-row">
                <div class="title-and-desc">
                    <h3 class="title"><?php echo JText::_('OPC_POPUP_BANNER_OPTION_TITLE_SHOW') ?></h3>
                    <p class="desc"><?php echo JText::_('OPC_POPUP_BANNER_OPTION_TITLE_SHOW_DESC') ?></p>
                </div>
                <div class="row-val">
            ...
            <div class="baner-row">
                <div class="title-and-desc">
                    <h3 class="title"><?php echo JText::_('OPC_POPUP_BANNER_OPTION_TITLE') ?></h3>
                    <p class="desc"><?php echo JText::_('OPC_POPUP_BANNER_OPTION_TITLE_DESC') ?></p>
                </div>
                <div class="row-val">
                    <input type="text" name="banerTitle" value="<?php echo $dataOption->banerTitle ?>" />
                </div>
            </div>
            <div class="baner-row">
                <div class="title-and-desc">
                    <h3 class="title"><?php echo JText::_('OPC_POPUP_BANNER_OPTION_IMAGES') ?></h3>
                    <p class="desc"><?php echo JText::_('OPC_POPUP_BANNER_OPTION_IMAGES_DESC') ?></p>
                </div>
                <div class="row-val">
                   <label class="select-images">
                        <input type="text" name="banerImg" class="media-textbox-value-css" value="<?php echo $dataOption->banerImg ?>" />
                        <span class="guru-media-img" onclick="openDialogMedia(this)"><?php echo JText::_('COM_VM_MANAGER_ACTION_SELECT') ?></span>
                    </label>
                </div>
            </div>
            <!---->
