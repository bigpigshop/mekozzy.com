...
$data = file_get_contents('components/com_vmmanager/helpers/config/payment.json');
...
<div id="popupHeader">
    <ul>
        <li data="#styleItem" class="active"><?php echo JText::_('OPC_POPUP_TABS_STYLE') ?></li>
    </ul>
</div>
<div id="popupItem">
    <div id="styleItem" class="active">
