...
$data = file_get_contents('components/com_vmmanager/helpers/config/confirm.json');
...
<div id="popupItem">
    ...
    <div id="privateItem" class="active">
        <form name="optionForm" action="#" method="POST" id="optionForm">
            <div class="baner-row">
                <div class="title-and-desc">
                    <h3 class="title"><?php echo JText::_('OPC_POPUP_COMFIRM_SHOWTITLE') ?></h3>
                    <p class="desc"><?php echo JText::_('OPC_POPUP_COMFIRM_SHOWTITLE_DESC') ?></p>
                </div>
                <div class="row-val">
