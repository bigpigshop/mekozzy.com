...
";
	...
	static function displayCustomMediaLink ($media_id, $table = 'product', $width = false, $height = false, $absUrl = false) {
		...
		return $media->getFileUrlThumb ('', FALSE, '', TRUE, TRUE, $absUrl, $width, $height);
	}
