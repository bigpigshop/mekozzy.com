...
require_once JPATH_VM_ADMINISTRATOR . '/helpers/vmdefines.php';
require_once JPATH_VM_ADMINISTRATOR . '/helpers/vobject.php';
require_once JPATH_VM_ADMINISTRATOR . '/helpers/vmLanguage.php';
vmDefines::defines();
vmDefines::core();
		...
		protected function vm_require()
		{
			...
			if (!class_exists('VmModel')) {
				if (defined('JPATH_VM_ADMINISTRATOR') && file_exists(JPATH_VM_ADMINISTRATOR . '/helpers/vmmodel.php')) {
                    require_once JPATH_VM_ADMINISTRATOR . '/helpers/vmmodel.php';
//                    echo JPATH_VM_ADMINISTRATOR . '/helpers/vmmodel.php';
				} else {
