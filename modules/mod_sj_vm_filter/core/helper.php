...
class VmFilterHelper
{
	...
	public function _getCategories($catids = null)
	{
		...
		usort ($categories,function ($a, $b){return $a->ordering > $b->ordering;});
		$_categories = array();
	...
	private function _oderByCategory($obj)
	{
		...
		switch ($_oderby){
			case 1:
				usort ($obj,function ($a, $b){return $a->category_name > $b->category_name;});
				break;
			case 2:
				usort ($obj,function ($a, $b){return $a->_countProduct < $b->_countProduct;});
				break;
			case 3:
				usort ($obj,function ($a, $b){return $a->ordering > $b->ordering;});
				break;
		}
		return $obj;
	}
