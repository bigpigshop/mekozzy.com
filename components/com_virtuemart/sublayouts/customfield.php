		...
		foreach($customfields as $key => $customfield){
			...
			switch ($type) {
				...
				case 'R':
					...
					$customfield->thumb_images = $thumb;
					$customfield->product_link = shopFunctionsF::renderVmSubLayout('related_link',array('customfield'=>$customfield,'related'=>$related, 'thumb'=>$thumb));
					...
					$customfield->product_name = $related->product_name;
					$customfield->infor = $related;
					$customfield->link_pic = VirtueMartModelCustomfields::displayCustomMediaLink( $related->virtuemart_media_id[0], 'product', $customfield->width, $customfield->height );
