...
<div id="<?php echo $menu_id; ?>" class="sambar <?php echo $params->get('style_layout', 'layout1')?>" data-sam="<?php echo $instance; ?>"><!--<![endif]-->
	<div class="sambar-inner menu_<?php echo $params->get('megamenutype', 'horizontal')?>">				
		<a class="btn-sambar" id="<?php echo $menu_id?>trigger" data-sapi="collapse" href="javascript:void(0)">
			...
			<span><?php echo JText::_('ALL_CATEGORIES') ?></span>
		</a>
				...
				<?php if( $params->get('menu_event') == 'click' ){?>
					$('.sj-menu-item > a', $menu).click( function(e){
						...
						if($parent.hasClass('actived')){
							...
							$sub.stop().animate( { height: "hide", "opacity" : "0" }, 2000, 'easeInQuad' );
						}
