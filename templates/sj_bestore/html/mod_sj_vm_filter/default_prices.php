			...
			<li class="ft-option ft-prices ">
				<div class="ft-opt-inner">
					<span class="ft-price-value ft-price-left">
						<input type="text" maxlength="9" class="ft-price-min ft-price-input" name="ft_price_min"
							   value="<?php echo $price_min; ?>"/>
						<span class="ft-price-curent">
							<?php echo $symbol; ?>
						</span>
					</span>
					<span class="ft-price-label"><?php echo JText::_('PRICE_TO');?></span>
					<span class="ft-price-value ft-price-right">
						<input type="text" maxlength="9" class="ft-price-max ft-price-input" name="ft_price_max"
