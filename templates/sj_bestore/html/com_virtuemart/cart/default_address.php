...
<div class="billto-shipto">
	<div class="width50 floatleft">
		...
		?>
		<a class="details <?php echo $this -> pointAddress ?>"
		   href="<?php echo JRoute ::_('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=BT', $this -> useXHTML, $this -> useSSL) ?>"
		   rel="nofollow">
	...
	<div class="width50 floatleft">
		...
		<a class="details"
		   href="<?php echo JRoute ::_('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&virtuemart_user_id[]=' . @$this -> cart -> lists['current_id'], $this -> useXHTML, $this -> useSSL) ?>"
		   rel="nofollow">
