    ...
    if ($this->order  ) {
      ...
      <div class="order-view">
        ...
        <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >
          ...
          <div class="col-lg-3 floatleft" id="com-form-order-number">
          ...
          <div class="col-lg-3 floatleft" id="com-form-order-pass">
          ...
          <div class="col-lg-3 floatleft" id="com-form-order-submit">
