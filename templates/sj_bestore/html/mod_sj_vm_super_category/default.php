...
if (!empty($list)) {
    ...
    <div id="<?php echo $tag_id; ?>" class="sj-sp-cat first-load"><!--<![endif]-->
        <?php if (!empty($options->posttext)) { ?>
            <div class="childcat-slider-content pull-left"><?php echo $options->posttext; ?></div>
        <?php } ?>  
        <div class="resp-slider-container">
            <?php if (!empty($options->pretext)) { ?>
                <div class="banner-category clearfix"><?php echo $options->pretext; ?></div>
            <?php } ?>    
            <?php require JModuleHelper::getLayoutPath($module->module, $layout . '_cat'); ?>
            <div class="slider responsive">
                <div class="spcat-tabs-container hidden"
            ...
            <?php if (!empty($list['tab'])) { ?>
                <?php foreach ($list['tab'] as $items) {
                    ...
                    <div class="spcat-items <?php echo $cls; ?>">
                        <div class="products-list spcat-items-inner <?php echo $cls_device . ' ';
                        echo $cls_animate; ?>"
                            >
