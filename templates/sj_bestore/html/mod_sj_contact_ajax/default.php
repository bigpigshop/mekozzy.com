		...
		<div class="ctajax-wrap">
			<div class="ctajax-element">
				<div class="el-inner">
					<div class="el-map">
						<?php if ($params->get('maps_display') == "1") { ?>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.205001505044!2d106.69930731474425!3d10.795605261791534!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528b66b71be8f%3A0x8a986ace165f3b07!2zNTcvNiDEkGnhu4duIEJpw6puIFBo4bunLCBQaMaw4budbmcgMTUsIELDrG5oIFRo4bqhbmgsIEjhu5MgQ2jDrSBNaW5oLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1589944530885!5m2!1svi!2s" width="100%" height="<?php echo $params->get('map_height')?>" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
						<?php } ?>
					</div>
					<?php
					$desc = trim($list->misc);
