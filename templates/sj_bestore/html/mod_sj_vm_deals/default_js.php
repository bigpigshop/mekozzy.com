...
jQuery(document).ready(function ($) {
	...
	$("#<?php echo $module_id;?> .owl-carousel .item").each(function(){
		...
		$(this).find('.item-deals').html('<div class="sj_deals_cd_day">'+(html_day)+'<p>Days</p></div><div class="sj_deals_cd_day">'+html_hours+'</div><div class="sj_deals_cd_day">'+html_minus+'</div><div class="sj_deals_cd_day">'+html_seconds+'</div>');
		i++;
		}
	});
		...
		$("#<?php echo $module_id;?> .sj_vm_deals_first_product .item").find('.item-deals').html('<div class="sj_deals_cd_day">'+(html_day)+'<p>Days</p></div><div class="sj_deals_cd_day">'+html_hours+'</div><div class="sj_deals_cd_day">'+html_minus+'</div><div class="sj_deals_cd_day">'+html_seconds+'</div>');
		}
