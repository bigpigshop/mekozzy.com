...
class plgSystemYtshortcodes extends JPlugin{
	...
	public function onBeforeCompileHead(){
		...
		if(( $app->isClient('') && isset($valRequest['view'])
                && @$valRequest['view'] == 'item'
                && isset($valRequest['task'])
                && $valRequest['task'] == 'edit') || ($app->isClient('')
                && isset($valRequest['view'])
                && $valRequest['view'] == 'form'
                && isset($valRequest['layout'])
                && $valRequest['layout'] == 'edit') || $app->isClient('administrator') || $valRequest['option'] == 'com_config' ||  $valRequest['option'] == 'com_users' || @$valRequest['view'] == 'registration'){
