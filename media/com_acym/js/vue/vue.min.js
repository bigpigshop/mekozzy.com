...
jQuery(document).ready(function ($) {
    ...
    function addTotalRecipients(selectedLists) {
        let ajaxUrl = ACYM_AJAX_URL + '&page=acymailing_campaigns&ctrl=campaigns&task=countNumberOfRecipients';
        ...
        const appVue = new Vue({
            ...
            methods: {
                ...
                getAllEntities(entity) {
                    ...
                    $.get(ACYM_AJAX_URL + '&ctrl=entitySelect&task=loadEntityFront&offset=' + entityNumber + '&perCalls=' + entityPerCalls + '&entity=' + entity + '&join=' + this.join + '&columns=' + this.columnsToDisplay.join(',') + joinColumn, (res) => {
                        res = JSON.parse(res);
                        if (undefined !== res.error) {
    ...
    if ($('#requireConfirmation').length > 0) {
        ...
        var subscriberVue = new Vue({
            ...
            methods: {
                ...
                getAllSubscribers() {
                    $.get(ACYM_AJAX_URL + '&ctrl=lists&task=loadMoreSubscribers&offset=' + this.total + '&perCalls=' + subPerCalls + '&listid=' + this.listid, (res) => {
                        res = JSON.parse(res);
